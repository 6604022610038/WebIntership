...
export default function Calendar({
  ...
  return (
    <div className="content">
      <PageTitle
        title="ปฏิทินกิจกรรม"
        subtitle="กำหนดนัดหมาย กิจกรรมการฝึกงาน และดูว่าวันไหนมีประกาศบ้าง"
        action={
          <button
            className="primary"
              ...
              return (
                ...
                >
                  ...
                  <span className="day-dots">
                    {dayActs.length > 0 && (
                      <span className="day-dot activity" title="มีกิจกรรม/นัดหมาย" />
                    )}
                    {dayAnns.length > 0 && (
                      <span className="day-dot announcement" title="มีประกาศ" />
                    )}
                  </span>
                </button>
              );
        ...
        <div className="day-detail">
          <div className="day-detail-section">
            <div className="day-detail-head">
              <h4>กิจกรรม/นัดหมายที่ปักหมุด ({selectedDayActivities.length})</h4>
